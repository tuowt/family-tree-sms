...
namespace FamilyTree\Kernel\Log;
...
class LogManager implements LoggerInterface {
    /**
     * @var \FamilyTree\Kernel\ServiceContainer
     */
    protected $app;
     ...
     *
     * @param \FamilyTree\Kernel\ServiceContainer $app
     */
    ...
    protected function createEmergencyLogger() {
        return new Monolog('FamilyTree', $this->prepareHandlers([
            new StreamHandler(
                \sys_get_temp_dir() . '/FamilyTree/FamilyTree.log', $this->level(['level' => 'debug'])
            )
        ]));
    }
